...
public class ActivityMainLogin extends AppCompatActivity implements ServerRequest.AsyncResponse {
    ...
    public void btn_login(View v){
        ...
        if(email.getText().toString().trim().replaceAll("\\s+","").equals("") || password.getText().toString().trim().replaceAll("\\s+","").equals("")){
            Toast.makeText(ActivityMainLogin.this,ActivityMainLogin.this.getResources().getString(R.string.fill_username_password),Toast.LENGTH_LONG).show();
        }
        else {
